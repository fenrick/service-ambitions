...
def _normalise_service(record: Dict[str, Any]) -> None:
...
def _normalise_plateaus(record: Dict[str, Any]) -> None:
...
def _normalise_meta(record: Dict[str, Any]) -> None:
...
def canonicalise_record(record: Dict[str, Any]) -> Dict[str, Any]:
    ...
    _normalise_service(record)
    _normalise_plateaus(record)
    _normalise_meta(record)
    return record
